export const projects = [
  ...
  {
    title: 'Ugly Things',
    description: "A form to demonstrate understanding of using React hooks and forms to display a collection of awful, unsavory creatures.",
  ...
  {
    title: 'Bounty Hunter',
    description: "A full stack application that stores form data in a Mongo DB and displays the galactic bounty data in a sleek Chakra UI.",
    image: '/images/bounty-hunter.PNG',
    tags: ['React', 'Mongo', 'Express', 'Chakra UI'],
    source: 'https://github.com/tyler-parker/bounty-hunter',
    visit: 'https://google.com',
    id: 3,
  },
];
